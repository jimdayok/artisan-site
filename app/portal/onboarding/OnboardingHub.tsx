...
function LabModule({ account }: { account: OnboardingAccount }) {
  ...
  return (
    <div>
      ...
      <div className="mt-5"><VideoPlaceholder title="Meet Your Lab" /></div>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <ScreenshotPlaceholder title="Portal home" />
        <ScreenshotPlaceholder title="Price list page" />
        <ScreenshotPlaceholder title="Reports/performance page" />
        <ScreenshotPlaceholder title="Account selector" />
      </div>
    </div>
  );
}
...
function ResourcesModule() {
  return (
    <div>
      ...
      <div className="mt-5"><ScreenshotPlaceholder title="Provider resources navigation" /></div>
    </div>
  );
}
