...
export const priceItems: PriceItem[] = [
  ...
  item("chemclip-solid-sunlens", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Solid Sunlens", 85.5),
  item("chemclip-drive", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Drive", 117),
  item("chemclip-solid-backside-ar", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Solid Sunlens with Backside AR", 88.5),
  item("chemclip-gradient-backside-ar", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Gradient Sunlens with Backside AR", 90.5),
  item("chemclip-mirror-sunlens", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Mirror Sunlens", 92.5),
  item("chemclip-color", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Color", 119),
  item("chemclip-readers-blue", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Readers Blue", 97),
  item("chemclip-therapeutic", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Therapeutic", 132),
  item("chemclip-avulux", "ChemClip", "ChemClip by Chemistrie", "Add-On", "ChemClip Avulux", 335),
  item("chemclip-swarovski", "ChemClip", "ChemClip by Chemistrie", "Add-On", "Swarovski Crystal add on", 20.5),
