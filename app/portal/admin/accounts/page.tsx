...
export default async function PortalAdminAccountsPage() {
  ...
  return (
    <AdminShell title="Portal Accounts (Advanced)" adminEmail={adminEmail}>
      <section className="mt-8 border border-[#d8c49b] bg-[#fffaf1]/84 p-6 shadow-[0_18px_55px_rgba(23,42,40,0.08)] sm:p-8">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-[#706759]">Account management and legacy workbook views are advanced tools and are hidden for launch. These screens remain accessible directly but are not part of the primary admin workflow.</p>
        <div className="mt-6">
