  ...
  return (
    <section className="rounded-3xl border border-[#dfd2bf] bg-[#fbf8f3]/95 p-5 shadow-[0_18px_48px_rgba(18,32,51,0.08)] md:p-7">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Link href="/private/price-list/packages" className="rounded-full bg-[#122033] px-4 py-2 text-sm font-bold text-white transition hover:bg-[#c7ad7b] hover:text-[#122033]">Package pricing</Link>
        <Link href="/private/price-list/policies" className="rounded-full border border-[#d7c5a8] bg-white px-4 py-2 text-sm font-bold text-[#122033] transition hover:bg-[#eadcc6]">Policies</Link>
