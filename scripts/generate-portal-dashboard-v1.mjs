...
const ACCOUNT_HEADER_ALIASES = {
  ...
  "Territory": ["Territory", "Account or Group Territory"],
  ...
  "PM Hi Index 1.60 Orders": ["PM Hi Index 1.60 Orders"],
  "PPM Hi Index 1.60 Orders": ["PPM Hi Index 1.60 Orders"],
  "CM Hi Index 1.67 Orders": ["CM Hi Index 1.67 Orders"],
  "PM Hi Index 1.67 Orders": ["PM Hi Index 1.67 Orders"],
  "PPM Hi Index 1.67 Orders": ["PPM Hi Index 1.67 Orders"],
  "CM Hi Index 1.74 Orders": ["CM Hi Index 1.74 Orders"],
  "PM Hi Index 1.74 Orders": ["PM Hi Index 1.74 Orders"],
  "PPM Hi Index 1.74 Orders": ["PPM Hi Index 1.74 Orders"],
  ...
  "PM IOT Artisan Orders": ["PM IOT Artisan Orders"],
  "PPM Unity Orders": ["PPM Unity Orders"],
  "PM Unity Orders": ["PM Unity Orders"],
  "CM Unity Orders": ["CM Unity Orders"],
  "PPM Preferred AR Jobs": ["PPM Preferred AR Jobs"],
  "PM Preferred AR Jobs": ["PM Preferred AR Jobs"],
  "CM Preferred AR Jobs": ["CM Preferred AR Jobs"],
  "PPM Non-Preferred AR Jobs": ["PPM Non-Preferred AR Jobs"],
  "PM Non-Preferred AR Jobs": ["PM Non-Preferred AR Jobs"],
  "CM Non-Preferred AR Jobs": ["CM Non-Preferred AR Jobs"],
...
const POWER_BI_ACCOUNT_FIELDS = {
  ...
  "Last State": "[state]",
  "Last Sales Rep": ["[sales_rep]", "[sales_rep_code]", "[last_sales_rep]"],
  "Territory": "[territory]",
  ...
  "PPM Unity Orders": ["[ppm_unity_orders]", "[ppm_unity_jobs]"],
  "PM Unity Orders": ["[pm_unity_orders]", "[pm_unity_jobs]"],
  "CM Unity Orders": ["[cm_unity_orders]", "[cm_unity_jobs]"],
  "PPM Preferred AR Jobs": ["[ppm_preferred_ar_jobs]", "[ppm_preferred_ar_orders]"],
  "PM Preferred AR Jobs": ["[pm_preferred_ar_jobs]", "[pm_preferred_ar_orders]"],
  "CM Preferred AR Jobs": ["[cm_preferred_ar_jobs]", "[cm_preferred_ar_orders]"],
  "PPM Non-Preferred AR Jobs": ["[ppm_non_preferred_ar_jobs]", "[ppm_nonpreferred_ar_jobs]"],
  "PM Non-Preferred AR Jobs": ["[pm_non_preferred_ar_jobs]", "[pm_nonpreferred_ar_jobs]"],
  "CM Non-Preferred AR Jobs": ["[cm_non_preferred_ar_jobs]", "[cm_nonpreferred_ar_jobs]"],
  ...
  "PPM Hi Index 1.60 Orders": "[ppm_hi_index_1_60_orders]",
  "PM Hi Index 1.60 Orders": "[pm_hi_index_1_60_orders]",
  "CM Hi Index 1.60 Orders": "[cm_hi_index_1_60_orders]",
  "PPM Hi Index 1.67 Orders": "[ppm_hi_index_1_67_orders]",
  "PM Hi Index 1.67 Orders": "[pm_hi_index_1_67_orders]",
  "CM Hi Index 1.67 Orders": "[cm_hi_index_1_67_orders]",
  "PPM Hi Index 1.74 Orders": "[ppm_hi_index_1_74_orders]",
  "PM Hi Index 1.74 Orders": "[pm_hi_index_1_74_orders]",
  "CM Hi Index 1.74 Orders": "[cm_hi_index_1_74_orders]",
...
function buildSupplementalIntelligence(row) {
  ...
  return {
    brand_usage: {
      ...
      unity_jobs: monthlyValues(row, "Unity Orders"),
    },
    ar_coating_mix: {
      available: [
        "PPM Preferred AR Jobs",
        "PM Preferred AR Jobs",
        "CM Preferred AR Jobs",
        "PPM Non-Preferred AR Jobs",
        "PM Non-Preferred AR Jobs",
        "CM Non-Preferred AR Jobs",
      ].some((field) => toText(row[field]) !== ""),
      preferred_ar_jobs: monthlyValues(row, "Preferred AR Jobs"),
      non_preferred_ar_jobs: monthlyValues(row, "Non-Preferred AR Jobs"),
    },
    material_usage: {
