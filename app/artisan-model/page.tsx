...
const timeline = [
  ["2018", "Pacific Artisan Labs launches"],
  ["2019", "Artisan AR Portfolio"],
  ["2021", "Artisan Design Series (IOT)"],
  ["2022", "Nytopia AR"],
  ["2024", "Tokai distribution"],
  ["2024", "VSP contract lab"],
  ["2025", "Varilux distribution"],
  ["2025", "Network expansion (Peak + Pike)"],
];
...
function SectionShell({
  ...
  return (
    <section
      id={id}
      data-theme={theme}
      className={`relative scroll-mt-24 px-5 py-20 md:px-8 md:py-24 lg:px-10 ${themeClass} ${className}`}
    >
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#171311] text-[#f7f1e8]">
      ...
      <section
        id="top"
        data-theme="dark"
        className="relative min-h-[720px] overflow-hidden px-5 pt-28 text-white md:min-h-[780px] md:px-8 lg:px-10"
      >
        <div
        ...
        <div className="relative z-10 mx-auto flex min-h-[620px] max-w-7xl items-center md:min-h-[680px]">
          <div className="max-w-4xl">
            <GoldRule />
            <h1 className="mt-8 text-4xl font-semibold leading-[1.04] tracking-tight md:text-6xl lg:text-7xl">
            ...
            <p className="mt-6 max-w-3xl border-l border-[#d4c09a]/60 pl-5 text-sm leading-7 text-white/68 md:text-base">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {problemItems.map((item, index) => (
              <div
                key={item.title}
                className={`group border border-white/12 bg-white/[0.045] p-6 shadow-[0_16px_50px_rgba(0,0,0,0.14)] backdrop-blur-md transition hover:-translate-y-1 hover:border-[#d4c09a]/50 hover:bg-white/[0.065] ${
      ...
      <SectionShell id="how-it-works" className="border-y border-[#d8c6a8]/40">
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-center">
          ...
          <div className="border border-[#d8c6a8]/55 bg-[#fffaf2]/75 p-7 shadow-[0_24px_80px_rgba(49,39,26,0.08)] md:p-9">
            <GoldRule />
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {networkPillars.map((pillar) => (
              <div
                key={pillar.title}
                className="border border-[#d8c6a8]/50 bg-[#171311] p-6 text-white shadow-[0_20px_70px_rgba(49,39,26,0.12)] transition hover:-translate-y-1 hover:border-[#d4c09a]/75 md:p-7"
              >
        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="grid gap-4">
            {partnershipItems.map((item) => (
              <div
                key={item.title}
                className="border-l-2 border-[#d4c09a] bg-white/55 p-6 shadow-[0_16px_55px_rgba(49,39,26,0.08)] transition hover:bg-white/80"
              >
      ...
      <SectionShell id="ownership" theme="dark" className="overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-8 space-y-6 border border-white/12 bg-black/22 p-6 text-base leading-8 text-white/72 shadow-[0_24px_90px_rgba(0,0,0,0.22)] backdrop-blur-md md:p-9 md:text-lg">
      ...
      <SectionShell id="timeline">
        <SectionHeader
          eyebrow="Timeline"
          title="Built With Intention. Grown With Discipline."
        />
        <div className="mt-12 grid gap-0 overflow-hidden border border-[#d8c6a8]/55 bg-[#fffaf2]/70 md:grid-cols-4">
          {timeline.map(([year, title]) => (
            <div
              key={`${year}-${title}`}
              className="border-b border-[#d8c6a8]/55 p-5 last:border-b-0 md:border-r md:last:border-r-0"
            >
              <div className="text-sm font-semibold text-[#9a8564]">{year}</div>
              <div className="mt-3 text-base font-semibold leading-snug text-[#1f1a17]">
                {title}
              </div>
            </div>
          ))}
      ...
      <section data-theme="dark" className="relative overflow-hidden px-5 py-20 text-white md:px-8 md:py-28 lg:px-10">
        <div
          className="absolute inset-0 bg-cover bg-center"
